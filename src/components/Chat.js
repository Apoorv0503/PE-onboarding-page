...
const Chat = () => {
  ...
  const steps = [
    {
      target: '.chat-step-1',
      content: 'After receiving a chat, if you are unsure about the user’s problem, ask for additional information. Use canned responses like "Could you please provide more details or a screenshot of the issue?"',
    },
    {
      target: '.chat-step-2',
      content: 'Once you understand the issue, try to solve it promptly. Most issues should be resolved within 40 minutes.',
    },
    {
      target: '.chat-step-3',
      content: 'Stay responsive to the user throughout the resolution process. Use canned responses like "We are actively working on your issue. Please wait for a moment."',
    },
    {
      target: '.chat-step-4',
      content: 'If further interaction is needed, provide a Google Meet link for a real-time discussion to resolve the query effectively.',
    },
    {
      target: '.ticket-step-1',
      content: 'If unable to resolve a chat issue within 1 hour, convert it into a ticket for further investigation and resolution.',
    },
    {
      target: '.ticket-step-2',
      content: 'Tickets should be resolved within 4 hours. Provide detailed documentation of the solution approach without sharing direct code snippets.',
    },
    {
      target: '.ticket-step-3',
      content: 'After resolving a ticket, mark it with appropriate labels indicating the resolution method (e.g., "Resolved on chat/Meet") and the level of assistance provided (e.g., "Minimal help", "Maximum help", "Medium help").',
    },
  ];
