...
const Onboarding = () => {
  ...
  const steps = [
    ...
    {
      target: '.step-2',
      content: 'Ask the candidate to introduce themselves, including their past experience and reasons for switching to a new profile.',
    },
    {
      target: '.step-3',
    ...
    {
      target: '.step-7',
      content: 'Ask 3-4 questions from DSA and request the candidate to share their screen.',
    },
    {
      target: '.step-8',
      ...
      <Container maxWidth="md" className="main-container">
        <Box sx={{ my: 4 }}>
          ...
          <Accordion className="step-2" sx={{ boxShadow: 3, mb: 2 }}>
            ...
            <AccordionDetails>
              <Typography variant="body1">
                Ask the candidate to introduce themselves, including past experience and reasons for switching to a new profile.
              </Typography>
            </AccordionDetails>
          </Accordion>
            ...
            <AccordionDetails>
              <Typography variant="body1">
                ...
                <ul>
                  ...
                  <li>2. Ask about the candidate's background and experience.</li>
                  <li>3. Inform them about the rounds: HTML, CSS, JavaScript, React, DSA, and Project discussion.</li>
                  <li>4. Detailed question Bank is provided: 
                  <Link to="https://docs.google.com/document/d/1EadT9A3aHFer8Y43BAi3yOc2P7My3dWiMvCFwli2xvE/edit" > here </Link> 
                  </li>
                </ul>
                </Box>
              </Typography>
            ...
            <AccordionDetails>
              <Typography variant="body1">
                ...
                <ul>
                  ...
                  <li>3. What is the difference between position: relative and position: absolute?</li>
                  <li>4. How to set media queries for different devices?</li>
                  <li>5. What is a meta tag in HTML?</li>
                  <li>6. Differentiate between semantic and non-semantic tags</li>
                </ul>
                </Box>
              </Typography>
            </AccordionDetails>
            ...
            <AccordionDetails>
              <Typography variant="body1">
                ...
                <ul>
                  ...
                  <li>4. What is this keyword? What does it point to by default? How does this work for arrow and regular function?</li>
                  <li>5. Difference between arrow function and regular functions</li>
                  <li>6. What are Closures in JS?</li>
                  <li>7. What are the differences between setTimeout() and setInterval()?</li>
                </ul>
                </Box>
              </Typography>
            </AccordionDetails>
          ...
          <Accordion className="step-6" sx={{ boxShadow: 3, mb: 2 }}>
            ...
            <AccordionDetails>
              <Typography variant="body1">
                ...
                <Box mt={2}>
                <ul>
                  <li>1. What is the difference between virtual DOM and real DOM?</li>
                  <li>2. What are lifecycle methods?</li>
                  <li>3. Why use useState instead of var in React components?</li>
                  <li>4. Explain useEffect</li>
                  <li>5. What is ReactJS?</li>
                  <li>6. What are hooks in ReactJS?</li>
                  <li>7. What are the differences between State and Props in ReactJS?</li>
                </ul>
                </Box>
              </Typography>
            </AccordionDetails>
          ...
          <Accordion className="step-8" sx={{ boxShadow: 3, mb: 2 }}>
            ...
            <AccordionDetails>
              <Typography variant="body1">
                Ask the candidate to showcase their best project. Ask them to open the code and live hosted version. Questions to ask:
                <Box mt={2}>
                <ul>
                  <li>Where did you face difficulty and how did you overcome it?</li>
                  <li>Explain specific parts of the UI/functionality and their implementation.</li>
                </ul>
                </Box>
              </Typography>
            </AccordionDetails>
          ...
          <Accordion className="step-9" sx={{ boxShadow: 3, mb: 2 }}>
            ...
            <AccordionDetails>
              <Typography variant="body1">
                After concluding the interview, fill up the feedback form. Give marks from 1 to 3 in all 6 sections (HTML/CSS, JavaScript, React, DSA, Project, and Overall Impression).
              </Typography>
            </AccordionDetails>
          </Accordion>
        </Box>
