...
const Onboarding = () => {
  ...
  const steps = [
    ...
    {
      target: '.step-4',
      content: 'Step 4: Try to give them approach first, in place of giving direct solution.',
    },
    {
      target: '.step-5',
      content: 'Step 5: Try to take doubts from the chat box of the meet too, do not ignore them.',
    },
    {
      target: '.step-6',
      content:
    ...
    {
      target: '.step-7',
      content: 'Step 7: After the given time, conclude the session if all the doubts are resolved',
    },
  ];
      ...
      <Container maxWidth="md" className="main-container">
        <Box sx={{ my: 4 }}>
          ...
          <Accordion className="step-2" sx={{ boxShadow: 3, mb: 2 }}>
            ...
            <AccordionDetails>
              <Typography variant="body1">
                ...
                <ul>
                  <li>Hi, I’m Apoorva Dwivedi (PE name). I’m here to take your doubts regarding MERN-1 sprint.</li>
                </ul>
              </Typography>
            </AccordionDetails>
          </Accordion>
          ...
          <Accordion className="step-3" sx={{ boxShadow: 3, mb: 2 }}>
            ...
            <AccordionDetails>
              <Typography variant="body1">
                ...
                <ul>
                  <li>When a user asks a doubt, ask them about their own approach first.</li>
                  <li>Example questions: How did you approach this problem? What steps did you take to resolve it? Which part is not clear to you?</li>
                </ul>
              </Typography>
            </AccordionDetails>
          </Accordion>
          ...
          <Accordion className="step-4" sx={{ boxShadow: 3, mb: 2 }}>
            ...
            <AccordionDetails>
              <Typography variant="body1">
                Try to give them an approach first, instead of giving a direct solution.
              </Typography>
            </AccordionDetails>
          </Accordion>
          ...
          <Accordion className="step-5" sx={{ boxShadow: 3, mb: 2 }}>
            ...
            <AccordionDetails>
              <Typography variant="body1">
                Try to take doubts from the chat box of the meeting as well. Do not ignore them.
              </Typography>
            </AccordionDetails>
          </Accordion>
          ...
          <Accordion className="step-6" sx={{ boxShadow: 3, mb: 2 }}>
            ...
            <AccordionDetails>
              <Typography variant="body1">
                If you are unable to solve a doubt immediately, assure them that you will try to find the solution and let them know in the next session. Do not spend excessive time on a single doubt; move forward with others.
              </Typography>
            </AccordionDetails>
          </Accordion>
          ...
          <Accordion className="step-7" sx={{ boxShadow: 3, mb: 2 }}>
            ...
            <AccordionDetails>
              <Typography variant="body1">
                After the allocated time, conclude the session if all doubts are resolved.
              </Typography>
            </AccordionDetails>
          </Accordion>
        </Box>
